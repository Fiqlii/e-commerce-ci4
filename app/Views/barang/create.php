        ...
        <div class="col-md-8">
            <form action="<?= base_url('admin/barang') ?>" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama" name="namabrg" value="<?= set_value('nama') ?>" placeholder="Nama Barang">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="any" class="form-control" id="beratdlmgram" name="beratdlmgram" value="<?= set_value('beratdlmgram') ?>" placeholder="Berat">
                </div>
                <div class="mb-3">
