    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-9">
            <div class="card p-3 shadow">
                <div class="card-body">
                    <h2 class="text-center mb-2">Detail Transaksi</h2>
                    <div class="text-center">
                        <i class="bi bi-check-circle fs-1 text-success"></i>
                    </div>
                    <p class="text-center mt-3 mb-5">
                        Terima kasih telah berbelanja. Pesanan Anda telah berhasil diproses dan akan segera dikirim.
                    </p>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9"><?= $data_transaksi[0]['tgl'] ?></div>
                    </div>
                    <div class="row mb-3">
                                ...
                                <table class="table table-sm table-hover">
                                    ...
                                    <tbody>
                                        <?php foreach ($data_transaksi as $key => $value) { ?>
                                            <tr>
                                                <td><?= $value['nama_barang'] ?><sub class="text-secondary">(<?= $value['berat'] / 1000 ?>kg)</sub></td>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <table class="table table-sm table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-center">Cimahi Selatan</td>
                                            <td class="text-center"><?= $data_transaksi[0]['kodepostujuan'] ?></td>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9 text-end">Rp. <?= number_format($data_transaksi[0]['total'], 0, ',', '.') ?>,-</div>
                            <hr>
                        </div>
                        <div class="d-grid gap-2 mt-5">
                            <a href="<?= base_url('/cart') ?>" class="btn btn-dark">Back to Home</a>
                        </div>
                    </div>
                </div>
            </div>
