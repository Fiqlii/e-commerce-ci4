<div class="container mt-5">
    <div class="row">
        <div class="col-md-7" style="color:#FFFF;">
            <h1>keranjang</h1>
        </div>
        <div class="col-md-5">
    ...
    <div class="row mt-3">
        <div class="col-md-7">
            <div class="row">
                                ...
                                <div class="table-responsive text-start" style="margin-left: 11px;">
                                    <table class="table">
                                        ...
                                        <?php foreach (session('cart') as $item) : ?>
                                            <tbody>
                                                <tr>
                                                    <td><strong><span style="color: inherit;"><?= $item['nama'] ?>&nbsp;</span></strong></td>
                ...
                <?php } else { ?>
                    <p class="text-center" style="color:#1a1a1a;">Keranjang Kosong</p>
                <?php } ?>
            </div>
        </div>
        <div class="col-md-5">
                ...
                <div class="card border rounded shadow p-4">
                    <form action="<?= base_url('checkout') ?>" method="POST">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label for="kodepostujuan" class="form-label">Kode Pos</label>
                                <select name="kodepostujuan" id="kodepostujuan" class="form-control">
                                    <option value="">-- Pilih --</option>
                                    <option value="40511">Cipageran - 40511</option>
                                    <option value="40512">Citereup - 40512</option>
                                    <option value="40513">Cibabat - 40513</option>
                                    <option value="40514">Pasirkaliki - 40514</option>
                                </select>
                            </div>
                        </div>
